...
public class shooterRollersSubsystem extends SubsystemBase {
    private final CANSparkMax upwardMotorRight = new CANSparkMax(10, MotorType.kBrushless); 
    private final CANSparkMax upwardMotorRightAbove = new CANSparkMax(36, MotorType.kBrushless);
