...
public class startCycle extends SequentialCommandGroup {
    ...
    public startCycle(intakeArmSubsystem m_IntakeArmSubsystem, intakeRollerSubsystem m_IntakeRollerSubsystem, shooterArmSubsystem m_ShooterArmSubsystem, shooterRollersSubsystem m_ShooterRollersSubsystem){
        ...
        addCommands(
            new SequentialCommandGroup(
                new intakeAmperage(m_IntakeRollerSubsystem),
